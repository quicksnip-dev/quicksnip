  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-secondary dark:data-[state=unchecked]:bg-secondary dark:data-[state=checked]:bg-primary-foreground pointer-events-none flex items-center justify-center size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0"
        )}
      >
        <Moon color="black" size={12} />
      </SwitchPrimitive.Thumb>
    </SwitchPrimitive.Root>
  );
}
